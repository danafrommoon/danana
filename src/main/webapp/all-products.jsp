...
<!---There shown all products in this shop--->
<!DOCTYPE html>
<html>
<head>
...
<header>
    ...
    <nav>
        <ul>
            <li><a href="Controller?page=main">Home</a></li>
            <c:choose>
                <c:when test="${session == null}">
                    <li><a href="Controller?page=login">Login</a></li>
                    <li><a href="Controller?page=register">Sign-up</a></li>
                </c:when>
                <c:when test="${session != null}">
            ...
            <li><a href="Controller?page=cart">cart(<c:out value="${x}"/>)</a></li>
        </ul>
    </nav>
</header>
...
<footer>
    <div class="footer"> &copy; 2020 Copyright:
        <a href="Controller?page=main"> Teadot.com</a>
    </div>
</footer>
